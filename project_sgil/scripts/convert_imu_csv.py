...
def main() -> None:
    ...
    out = pd.DataFrame(
        ...
        columns=[
            ...
            "zed_imu_orientation_x",
            "zed_imu_orientation_y",
            "zed_imu_orientation_z",
            "zed_imu_orientation_w",
            "zed_imu_angular_velocity_x",
            "zed_imu_angular_velocity_y",
            "zed_imu_angular_velocity_z",
            "zed_imu_linear_acceleration_x",
            "zed_imu_linear_acceleration_y",
            "zed_imu_linear_acceleration_z",
            "cheap_imu_angular_velocity_x",
            "cheap_imu_angular_velocity_y",
            "cheap_imu_angular_velocity_z",
            "cheap_imu_linear_acceleration_x",
            "cheap_imu_linear_acceleration_y",
            "cheap_imu_linear_acceleration_z",
            "zed_pose_position_x",
            "zed_pose_position_y",
            "zed_pose_position_z",
            "zed_pose_orientation_x",
            "zed_pose_orientation_y",
            "zed_pose_orientation_z",
            "zed_pose_orientation_w",
            "rtk_lat",
            "rtk_lon",
            "rtk_alt",
            "rtk_heading",
