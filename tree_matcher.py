...
class TreeMatcher:
    ...
    def debug_plot_aoi(self, all_sat_tree_loc, aoi_sat_trees, current_pose):
        """
        ...
        if current_pose:
            ax.scatter(current_pose[0], current_pose[1], s=100, c='red', 
            ...
            ax.arrow(current_pose[0], current_pose[1], dx, dy, 
                    head_width=1, head_length=2, fc='red', ec='red')
        
        # Add AOI radius circle
        if current_pose:
            circle = plt.Circle((current_pose[0], current_pose[1]), AOI_RADIUS_M, 
    ...
    def wedge_matching(self, wedges, current_pose):
        ...
        return (current_pose[0], current_pose[1])  # Return current position if no better estimate found
    ...
    def analyze_vector_intersections(self, vectors):
        """
        Analyze intersections of vectors to find centroid and standard deviation
